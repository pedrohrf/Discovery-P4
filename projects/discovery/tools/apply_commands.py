...
if __name__ == '__main__':
	...
	apply_commands('discovery', 'discovery', '9090', 's0.txt')
	print('\nCOMMAND #2 - THRIFT 9091')
	apply_commands('discovery', 'discovery', '9091', 's1.txt')
	print('\nCOMMAND #3 - THRIFT 9092')
	apply_commands('discovery', 'discovery', '9092', 's2.txt')
	print('\nCOMMAND #4 - THRIFT 9093')
	apply_commands('discovery', 'discovery', '9093', 's3.txt')
	print('\nCOMMAND #4 - THRIFT 9094')
	apply_commands('discovery', 'discovery', '9094', 's4.txt')